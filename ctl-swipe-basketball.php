<?php
    /*
    Plugin Name: CTL Arcade - Swipe Basketball
    Plugin URI: http://www.codethislab.com/
    Description: Swipe Basketball for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeSwipeBasketball{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-swipe-basketball";
        private $_szPluginName              = "Swipe Basketball";
        private $_szAspectRatio             = "5:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "3 points, basket, basketball,physics game, Shoot-out, shootout, shot, skill game, sport, sport game, swish, three points, Ketchapp, Ketchapp basketball, flat game";
    ...
    $g_oCTLArcadeSwipeBasketball =  new CTLArcadeSwipeBasketball();
